		...
		<div class="row" style="height: 500px; text-align: center;">
			<div class="col-md-10 col-md-push-1">
				<table class="table  table-condensed">
					...
					<tr>
						<td>图片</td>
						<td><img src="${sessionScope.itinvenpro.attr4 }" /></td>
					</tr>
					<tr>
						<td>编号</td>
						<td>${sessionScope.itinvenpro.itemid }</td>
					</tr>
					<tr>
						<td>书名</td>
						<td>${sessionScope.itinvenpro.name }</td>
					</tr>
					<tr>
						<td>库存</td>
						<td>${sessionScope.itinvenpro.qty }</td>
					</tr>
					<tr>
						<td>价格</td>
						<td>${sessionScope.itinvenpro.unitprice }</td>
					</tr>
					<tr>
						<td colspan="2"><a
							href="DoCart?itemid=${sessionScope.itinvenpro.itemid }">add
								to cart</a></td>
					</tr>
